          ...
          <Column className="items-center justify-start xl:p-[115px] 2xl:p-[130px] 3xl:p-[156px] lg:p-[92px] w-[100%]">
            ...
            <Stack className="lg:h-[572px] xl:h-[715px] 2xl:h-[804px] 3xl:h-[965px] 3xl:mb-[1072px] lg:mb-[635px] xl:mb-[794px] 2xl:mb-[893px] lg:mt-[21px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] w-[94%]">
              <Column className="absolute bg-white_A700 items-center justify-center lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] right-[0] rounded-radius16 w-[100%]">
                ...
                <Row className="font-poppins items-center justify-between lg:mb-[19px] xl:mb-[24px] 2xl:mb-[28px] 3xl:mb-[33px] lg:mt-[223px] xl:mt-[279px] 2xl:mt-[314px] 3xl:mt-[377px] w-[100%]">
                  ...
                  <Column className="items-center w-[24%]">
                    <Button
                      className="font-normal not-italic lg:text-[14px] xl:text-[17px] 2xl:text-[20px] 3xl:text-[24px] text-center w-[100%]"
                    ...
                    <Button
                      className="font-normal lg:mt-[21px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] not-italic lg:text-[14px] xl:text-[17px] 2xl:text-[20px] 3xl:text-[24px] text-center w-[100%]"
                      shape="RoundedBorder20"
                      size="xl"
              ...
              <Column
                ...
                style={{
                  backgroundImage:
                    "url('images/img_reservationhas_232X1112.png')",
                }}
              >
                <Text
                  className="font-semibold lg:ml-[13px] xl:ml-[16px] 2xl:ml-[19px] 3xl:ml-[22px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] text-white_A700 w-[auto]"
                  as="h5"
                  variant="h5"
                >
                  Are you sure you want to cancel the reservation?
                </Text>
                <Row className="items-start lg:ml-[13px] xl:ml-[16px] 2xl:ml-[19px] 3xl:ml-[22px] mr-[auto] lg:mt-[23px] xl:mt-[29px] 2xl:mt-[33px] 3xl:mt-[39px] w-[24%]">
                  <Img
